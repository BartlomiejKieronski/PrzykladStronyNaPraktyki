...
<div class="sticky-top">
    ...
    <div class="container-fluid" >
      <div class="mx-auto" style="width: 800px;">
            <div class="mt-5">
            <form action="newdevice.inc.php" method="post">
            <div class="row">
             <div class="col">
                <input type="Text" class="form-control" id="NumerTelefonuWlasciciela" name="NumerTelefonuWlasciciela"  placeholder="Numer Telefonu Właściciela" required>
                <input type="E-mail" class="form-control" id="AdresEmail" name="AdresEmail" placeholder="Adres E-mail Właściciela" required>
                <input type="Text" class="form-control" id="ImieWlasciciela" name="ImieWlasciciela" placeholder="Imię Właściciela" required>
                <input type="Text" class="form-control" id="NazwiskoWlasciciela" name="NazwiskoWlasciciela" placeholder="Nazwisko Właściciela" required>
              </div>
                <div class="col mt-3">
                <select class="form-select" id="TypUrzadzenia" name="TypUrzadzenia"  aria-label="Typ urządzenia">
                  <option selected>Typ Urządzenia</option>
                ...
                <input type="Text" class="form-control" id="MarkaUrzadzenia" name="MarkaUrzadzenia" placeholder="Marka Urządzenia" required>
                <input type="Text" class="form-control" id="ModelUrzadzenia" name="ModelUrzadzenia" placeholder="Model urządzenia" required>
                </div>
                <div class="mt-2">
                  <textarea class="form-control" id="OpisanyProblem" name="OpisanyProblem" cols="40" rows="5" placeholder="Problem opisany przez właściciela" required></textarea>
                </div>
                <div class="mt-2">
